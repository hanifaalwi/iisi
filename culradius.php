...
$querysearch="SELECT id, name, 
	...
	st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1), culinary_place.geom) as jarak 
	FROM culinary_place where st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1),
