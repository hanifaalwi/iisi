...
<body onload="init();detailinfokul('<?php echo $_GET["idgallery"] ?>');">
  ...
  <section id="container" >
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a class="logo" ><p><img src="">WegGis Culinary (10 1811521011 Hanifa Alwi)</p></a>
      ...
      url: server+'detailinfokul.php?info='+id144, data: "", dataType: 'json', success: function(rows)
        { 
         for (var i in rows) 
          ...
          detculi(id144);
          //$('#detgal').append("<tr><td style='text-align:left'> "+isi+"</td></tr>");
        }
      }); 
}
        ...
        { 
          ...
          else
          {
            ...
            { 
              ...
              clickMarker(centerBaru, id);
              map.setCenter(centerBaru);
               $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success' onclick='detculi(\""+id+"\");detailinfokul(\""+id+"\");'>Show</a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='kulAngkot(\""+id+"\")'></a></td></tr>");
            }
          } 
