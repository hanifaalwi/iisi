...
$querysearch="SELECT id, nama_industri, 
	...
	st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1), industri_kecil_region.geom) as jarak 
	FROM industri_kecil_region where st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1),
