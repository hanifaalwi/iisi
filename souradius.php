...
$querysearch="SELECT id_oleh_oleh, nama_oleh_oleh, 
	...
	st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1), oleh_oleh.geom) as jarak 
	FROM oleh_oleh where st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1),
	 oleh_oleh.geom) <= ".$rad."	
			 "; 
