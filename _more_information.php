                      ...
                      <?php 
                       ...
                       // echo "ini $id";
                        ...
                        if(strpos($id,"H") !== false){
                          $sqlreview = "SELECT * from administrators where id_hotel = '$id'";
                        }elseif (strpos($id,"RM") !== false) {
                          $sqlreview = "SELECT * from administrators where id_kuliner = '$id'";
                        }elseif (strpos($id, "SO") !== false) {
                          $sqlreview = "SELECT * from administrators where id_souvenir = '$id'";
                        }elseif (strpos($id,"IK") !== false) {
                           $sqlreview = "SELECT * from administrators where id_ik = '$id'";
                        }elseif (strpos($id,"tw")!== false) {
                           $sqlreview = "SELECT * from administrators where id_ow = '$id'";
                        }
                    ...
                    if($_SESSION['C'] == true)
                      {
                        ...
                        //echo "nama $username";
                          echo "
                            ...
                            <tr>
                              <td><input type='submit' name='' value='send'></td><td>
                              <input name='nama' value='$username' hidden></td>
                            </tr>";
                      }
                     ?>                            
                          </tbody>          
